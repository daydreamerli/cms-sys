...
function itemRender(route: Router) {
  return route.path === 'index' ? (
    <Link href={'/dashboard/student/menu1'}>
...
const DashLayout2 = (props: React.PropsWithChildren<Props>) => {
      ...
      >
        ...
        >
          ...
          <Item key="menu2" icon={<DashboardOutlined />}>
            <Link href="/dashboard/student/menu2">
              <a>Menu 2</a>
            </Link>
          </Item>
          <SubMenu key="menu3" icon={<SettingOutlined />} title="Menu 3">
            <Item key="submenu1">
              <Link href="/dashboard/student/menu3/submenu1">
                <a>Submenu 1</a>
              </Link>
            </Item>
            <Item key="submenu2">
              <Link href="/dashboard/student/menu3/submenu2">
                <a>Submenu 2</a>
              </Link>
            </Item>
          </SubMenu>
...
export default withRouter(DashLayout2);
